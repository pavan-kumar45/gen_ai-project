...
-A correct answer (8-10 marks) should have most of the key parts related to question.
-A partially correct answer (4-6 marks) should have some key parts but may have minor inaccuracies or omissions.
-A wrong answer (0-3 marks) should have significant inaccuracies or be missing key parts related to question.
